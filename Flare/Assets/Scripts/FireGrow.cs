...
{
    public static float startSize=1;
    ...
    IEnumerator increaseByNum()
    {
        ...
        if ((startSize > 4) && (startSize < 5))
        {
            ...
            if (x == 0)
            {
                ...
                {
                    newV.x += 10f;
                    GameObject newFire=Instantiate(prefab, newV, Quaternion.identity);
                    Random_fire.fireList.Add(newFire);
                    Debug.Log("produce a new fire");
                }
