...
public class RoleBehavior : MonoBehaviour
{
    ...
    public UIProgressBar bloodBar;
    private float decrease = 5f;
    ...
    private void OnControllerColliderHit(ControllerColliderHit hit)
    {
        ...
        Debug.Log(hitObject.name + " collides the player");
        if (hitObject.name == "ColliderTest")
        {
            //如果与火焰中碰撞检测器碰到
