...
public class Role_Fire : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bloodBar.value = 1f;
        //moveSpeed = 1.0f;
        //bloodBar=GameObject.Find("Main Camera").GetComponent<GameState>.
    }
    ...
    public void OnControllerColliderHit(ControllerColliderHit hit)
    {
        ...
        if (hitObject.transform.name == "ColliderTest")
        {
            ...
            //血量减少
            //blood -= deSpeed;
            //Debug.Log("the blood now is " + bloodBar.value);
            //控制显示
            //标签和血条
        ...
        {
            //GameObject.Find("Main Camera").GetComponent<GameState>().gameWin();
        }
