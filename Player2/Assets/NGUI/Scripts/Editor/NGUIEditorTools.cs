...
static public class NGUIEditorTools
{
	...
	static public int GetClassID<T> () where T : UnityEngine.MonoBehaviour { return GetClassID(typeof(T)); }

	/// <summary>
	/// Convenience function that replaces the specified MonoBehaviour with one of specified type.
	/// </summary>

	static public SerializedObject ReplaceClass (UnityEngine.MonoBehaviour mb, System.Type type)
	{
	...
	static public SerializedObject ReplaceClass (UnityEngine.MonoBehaviour mb, int classID)
	{
		SerializedObject ob = new SerializedObject(mb);
		ob.Update();
	...
	static public T ReplaceClass<T> (UnityEngine.MonoBehaviour mb) where T : UnityEngine.MonoBehaviour { return ReplaceClass(mb, typeof(T)).targetObject as T; }
