...
static public class NGUIContextMenu
{
	...
	static void AddMissingItem<T> (GameObject target, string name) where T : UnityEngine.MonoBehaviour
	{
	...
	static void AddChild<T> (object obj) where T : UnityEngine.MonoBehaviour
	{
	...
	{
        UnityEngine.MonoBehaviour[] comps = Selection.activeGameObject.GetComponents<UnityEngine.MonoBehaviour>();
