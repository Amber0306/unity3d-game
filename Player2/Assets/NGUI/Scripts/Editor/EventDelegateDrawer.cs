...
public class EventDelegateDrawer : PropertyDrawer
{
	...
	public override float GetPropertyHeight (SerializedProperty prop, GUIContent label)
	{
		...
		del.target = targetProp.objectReferenceValue as UnityEngine.MonoBehaviour;
	...
	public override void OnGUI (Rect rect, SerializedProperty prop, GUIContent label)
	{
        ...
        UnityEngine.MonoBehaviour target = targetProp.objectReferenceValue as UnityEngine.MonoBehaviour;
		...
		target = EditorGUI.ObjectField(lineRect, "Notify", target, typeof(UnityEngine.MonoBehaviour), true) as UnityEngine.MonoBehaviour;
		...
		if (target != null && target.gameObject != null)
		{
			...
			if (choice > 0 && choice != index)
			{
				...
				target = entry.target as UnityEngine.MonoBehaviour;
