...
public class EventDelegate
{
	...
	[SerializeField] UnityEngine.MonoBehaviour mTarget;
	...
	public bool isEnabled
	{
		get
		{
            ...
            UnityEngine.MonoBehaviour mb = (mTarget as UnityEngine.MonoBehaviour);
	...
	public EventDelegate (UnityEngine.MonoBehaviour target, string methodName) { Set(target, methodName); }
	...
	public override bool Equals (object obj)
	{
		...
		if (obj is Callback)
		{
            ...
            UnityEngine.MonoBehaviour mb = callback.Target as UnityEngine.MonoBehaviour;
	...
	void Set (Callback call)
	{
		...
		{
#if REFLECTION_SUPPORT
            mTarget = call.Target as UnityEngine.MonoBehaviour;
	...
	public void Set (UnityEngine.MonoBehaviour target, string methodName)
	{
		Clear();
		mTarget = target;
...
#if REFLECTION_SUPPORT
		if (mCachedCallback == null || (mCachedCallback.Target as UnityEngine.MonoBehaviour) != mTarget || GetMethodName(mCachedCallback) != mMethodName)
		{
